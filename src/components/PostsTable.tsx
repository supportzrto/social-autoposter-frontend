...
import { Status, Post } from "@/types/post";
  ...
  const filteredPosts = posts.filter((post) => {
    ...
    switch (dateFilter) {
      ...
      case "yesterday":
        ...
        matchesDate = postDate.toDateString() === yesterday.toDateString();
      ...
      case "last7days":
        ...
        matchesDate = postDate >= last7 && postDate <= now;
      ...
      case "last30days":
        ...
        matchesDate = postDate >= last30 && postDate <= now;
      ...
      case "lastMonth":
        ...
        matchesDate =
          postDate.getMonth() === lastMonthDate.getMonth() &&
          postDate.getFullYear() === lastMonthDate.getFullYear();
  ...
  return (
    <div>
      <PostFilters
        ...
        onStatusChange={(value) => setStatusFilter(value as "all" | Status)}
  ...
  "
    ...
    "
            ...
            ${PLATFORM_STYLES[platform.trim()]}`}
                  ...
                  >
                    {new Date(post.schedule_time).toLocaleString("en-IN", {
